...
import Break from '../../Assets/Images/Error/Break.svg'
    ...
    return (
        <Grid container className={classes.mainErrorSection}>
            <Grid item xs={isMobileDevice ? 8 : 12} className={classes.errorSection}>
                <img src={Break} alt='404Error' />
            </Grid>
            <Grid item xs={12} className={classes.errorHead}>
                <SectionFour
                    className={classes.sectionFour}
                    title='404 Error!'
                    content='The page you are looking for is not available or doesn’t belong to this website!'
                />
            </Grid>
